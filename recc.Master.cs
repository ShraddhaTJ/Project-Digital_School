...
namespace home
{
    public partial class recc : System.Web.UI.MasterPage
    {
        protected void Page_Load(object sender, EventArgs e)
        {
          ...
          //  SqlConnection con = new SqlConnection(@"Data Source=lenovo\sqlexpress;Initial Catalog=saloni;Integrated Security=True");
          //  con.Open();
          ...
          //  con = new SqlConnection(@"Data Source=lenovo\sqlexpress;Initial Catalog=saloni;Integrated Security=True");
          //  con.Open();
          ...
          //  }
            ...
            //    //Response.Redirect("~/arts.aspx");
            //}
            //else if (a5 > a2 && a5 > a3 && a5 > a4 && a5 > a1 && a5 > a6 && a5 > a7)
            //{
            //    Label1.Text = "We recommend you to opt for Science as your career path";
            //    //Response.Redirect("~/sci.aspx");
            //}
            ...
            //if (Label1.Text == "We recommend you to opt for Arts as your career path")
            //{
            //    Response.Redirect("arts.aspx");
            //}
            //else if (Label1.Text == "We recommend you to opt for Science as your career path")
            //{
            //    Response.Redirect("sci.aspx");
            //}
            //else if (Label1.Text == "We recommend you to opt for Commerce as your career path")
            //{
            //    Response.Redirect("commerce.aspx");
            //}
        }
        ...
        {
            //Response.Redirect("diplomacomp.aspx");
            Response.Redirect("diploma.aspx");
        }
